-- =============================================================================
-- ARCHIVE / MIRRORED REFERENCE ONLY
-- Migration: 001_initial_data_architecture (PostgreSQL Reference Archive)
-- Description: Initial Relational Healthcare Data Architecture for MEDIMESH INDIA 2.0
-- CANONICAL MIGRATION SOURCE: prisma/migrations/20260917000000_init_data_architecture/migration.sql
-- CANONICAL SCHEMA SOURCE: prisma/schema.prisma
-- Target: PostgreSQL
-- NOTE: This file is a mirrored archive for PostgreSQL tracking and version history.
-- It is NOT a second independently maintained migration source.
-- =============================================================================
