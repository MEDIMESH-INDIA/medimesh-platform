...
export default function Compare() {
  ...
  return <AppPageContainer className="!max-w-[1320px]">
    ...
    <FrostedPanel variant="elevated" className="mb-7 overflow-hidden rounded-[28px]">
...
function Notice({ title, children }) { return <div className="rounded-2xl border border-coral/25 bg-coral/[.06] p-5 text-sm text-[#8E463F]"><div className="flex gap-2"><AlertCircle className="h-5 w-5" /><div><strong>{title}</strong><p className="mt-1">{children}</p></div></div></div>; }
