...
export default function EmptyState({ icon: Icon, eyebrow, title, description, action }) {
  return (
    <FrostedPanel className="mx-auto max-w-xl rounded-[24px] border-dashed p-8 text-center sm:p-10">
      {Icon && <span className="mx-auto grid h-14 w-14 place-items-center rounded-[18px] border border-border bg-white/70 text-primary"><Icon className="h-6 w-6" /></span>}
